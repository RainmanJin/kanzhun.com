  ...
  $(function () {
    ...
    $('#jobSuggest').autocomplete({
      ...
      formatResult: function (suggestion, currentValue) {
        return '<a href="/activity/bsalary/joblist?id='+ suggestion.id +'">' + '<span>共'+ suggestion.data +'条工资</span>' + suggestion.value + '</a>';
      }
    });
    ...
    $('#coSuggest').autocomplete({
      ...
      //修改最终显示的信息
      formatResult: function (suggestion, currentValue) {
        return '<a href="/activity/bsalary/companyindex/?companyId='+ suggestion.id +'">' + '<span>共'+ suggestion.data +'条工资</span>' + suggestion.value + '</a>';
      }
    });
