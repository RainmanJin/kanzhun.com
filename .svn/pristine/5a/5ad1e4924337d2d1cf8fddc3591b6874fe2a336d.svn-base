...
require(['u/autocomplete','s/chart-v2', 'u/tabs'], function(){
  $(function(){
    ...
    var pk = function(data, callback){
      ...
      $.ajax({
        url: '/activity/appbcompany/load.json',
        type: 'get',
        data: _data,
        dataType: 'json',
    ...
    $('div.tagList').on('click', '>span', function(){
      ...
      if(!$this.hasClass('current')){
        ...
        $.ajax({
          url:'/activity/appbcompany/tag.json',
          data:{
    ...
    $('.bt_comment',commentTool).on('click',function(){
      ...
      $.ajax({
        type: 'post',
        url: '/activity/appbcompany/publish.json',
        dataType: 'json',
        data: {
          companyId:comId1,
          originId:comId2,
    ...
    scaleLine.on('click','a',function(){
      ...
      if(!_t.hasClass('current')&&isSupport){
        ...
        $.ajax({
          url:'/activity/appbcompany/support.json',
          data:data,
          dataType:'json',
          success:function(result){
            if(result.rescode==1){
    ...
    $('a.more_details').on('click', function(){
      var _t = $(this);
      $.ajax({
        url: '/activity/appbcompany/review.json',
        dataType:'json',
        data:{
